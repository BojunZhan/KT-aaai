...
sweep_names=(wvedlcf3 wvedlcf3 wvedlcf3 wvedlcf3 wvedlcf3 wvedlcf3 wvedlcf3 wvedlcf3)
...
for ((i=0; i<${#gpu_ids[@]}; i++)); do
    ...
    command="CUDA_VISIBLE_DEVICES=$gpu_id wandb agent 1540712456/akt-0.2/$sweep &"
