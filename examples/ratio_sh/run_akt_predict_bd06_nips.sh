...
sweep_names=(ga4cqgwk ksmcrp0b 7v43rehh sihpl5qv 3b2hv0b3 kobalaml 0wtzaog2 3g947n75)
...
for ((i=0; i<${#gpu_ids[@]}; i++)); do
    ...
    command="CUDA_VISIBLE_DEVICES=$gpu_id wandb agent 1540712456/akt_predict_project/$sweep &"
