...
sweep_names=(imyi5rm5 imyi5rm5 imyi5rm5 imyi5rm5 imyi5rm5 imyi5rm5 imyi5rm5 imyi5rm5)
...
for ((i=0; i<${#gpu_ids[@]}; i++)); do
    ...
    command="CUDA_VISIBLE_DEVICES=$gpu_id wandb agent 1540712456/akt-int-ratio/$sweep &"
