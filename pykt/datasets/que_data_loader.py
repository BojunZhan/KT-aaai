...
class KTQueDataset(Dataset):
    ...
    """
    def __init__(self, file_path, input_type, folds,concept_num,max_concepts, qtest=False,train_ratio=1.0):
        ...
        if not os.path.exists(processed_data):
            ...
            self.dori = self.__load_data__(sequence_path, folds,train_ratio=train_ratio)
            save_data = self.dori
